...
module.exports = {
    commandInfo: {
        name: "removeallstw",
        description: "Allows you to remove a user all stw. Note: This will reset all your lockers to default",
        options: [
            {
                name: "user",
                description: "The user you want to remove the stw to",
                required: true,
                type: 6
            }
        ]
    ...
    execute: async (interaction) => {
        ...
        try {
            ...
            const allItems = destr(fs.readFileSync(path.join(__dirname, "../../../Config/DefaultProfiles/campaign.json"), 'utf8'));
            if (!allItems) {
            ...
            const embed = new MessageEmbed()
                .setTitle("Full STW Removed")
                .setDescription("Successfully removed all STW  to the selected account")
                .setColor("GREEN")
                .setFooter({
                    text: "Reload Backend",
